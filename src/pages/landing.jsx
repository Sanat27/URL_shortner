...
const handleShorten=(e)=>{
  ...
  return (
    <div className="flex flex-col items-centre px-4" >
      <h2 className ="my-10 sm:my-16 text-3xl sm:text-6xl lg:text-7xl text-white text-centre font-extrabold">
        The only URL Shortner <br/> you&rsquo;ll ever need !
      </h2>
      <form
       onSubmit={handleShorten}
      className="sm: h-14 flex flex-col sm:flex-row w-full md:w-2/4 gap-2 mb-4">
        <Input 
        type="url"
        value={longUrl}
    ...
    <AccordionContent>
      When u enter a long URL, our system generates a shorter version 
